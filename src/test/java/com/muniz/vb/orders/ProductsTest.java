...
public class ProductsTest {
	...
	public void testListProducts() throws Exception{
		mvc.perform(get(URL))
			...
			.andExpect(content().json(readJson("products/response.json")));
	}
	...
	public void testAddProducts() throws Exception{
		...
		mvc.perform(post(URL)
		        ...
		        .content(readJson("products/request.json")))
	...
	public void testAddProductsEmpty() throws Exception{
		mvc.perform(post(URL)
                ...
                .andExpect(content().json(readJson("products/response_empty.json")));
	...
	public void testUpdateProduct() throws Exception{
		mvc.perform(patch(URL + "/A1" )
				.contentType(MediaType.APPLICATION_JSON_UTF8_VALUE)
				.content(readJson("products/request_update.json")))
				.andExpect(status().isOk())
		;
